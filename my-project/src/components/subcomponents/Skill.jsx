...
function Skill() {
    return (
        <div className="pt-24 lg:pt-0"> {/* Add padding-top for separation */}
            ...
            {/* For larger screens */}
            <div className="hidden lg:flex space-x-16 overflow-hidden bg-neutral-950 pb-44 group">
                <div className="flex w-full animate-loop-scroll space-x-16 sm:space-x-16 group-hover:paused">
                ...
                <div className="flex space-x-16 w-full animate-loop-scroll group-hover:paused" aria-hidden="true">
                    <img src="/images/1.png" alt="HTML" className="max-w-none" />
                    <img src="/images/2.png" alt="CSS" className="max-w-none" />
                    <img src="/images/3.png" alt="JavaScript" className="max-w-none" />
                    <img src="/images/4.png" alt="React JS" className="max-w-none" />
