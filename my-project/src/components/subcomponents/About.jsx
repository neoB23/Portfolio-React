...
function About() {
    return (
        <div className="flex justify-center item-center flex-col lg:flex-row items-center bg-neutral-950 p-4 lg:p-12 text-white pt-12 lg:pt-44">
            <img 
                src="/images/image1.jpg" 
                className="rounded-lg w-full max-w-md lg:max-w-lg mb-5 lg:mb-0 lg:mr-8 mt-4 lg:mt-0" 
                alt="Logo" 
            />
            <div className="max-w-full lg:max-w-2xl px-4 lg:px-6">
                ...
                <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-4 mt-8">About Me</h1>
