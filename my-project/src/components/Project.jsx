    ...
    return (
        <section className="pt-44">
            <div className="container max-w-6xl p-6 mx-auto space-y-6 sm:space-y-12">
                <a rel="noopener noreferrer" href="#" className="block max-w-sm gap-3 mx-auto sm:max-w-full group hover:no-underline focus:no-underline lg:grid lg:grid-cols-12 bg-[#ffffff08] rounded-lg">
                    ...
                    <div className="p-6 space-y-2 lg:col-span-5 bg-[#ffffff08] rounded-b-lg lg:rounded-b-none lg:rounded-r-lg">
