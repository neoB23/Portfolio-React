    ...
    return (
        <section className="pt-44">
            ...
            <div className="container max-w-6xl p-6 mx-auto space-y-6 sm:space-y-12">
                <a rel="noopener noreferrer" href="https://justdevv.vercel.app/" className="block max-w-sm gap-3 mx-auto sm:max-w-full group hover:no-underline focus:no-underline lg:grid lg:grid-cols-12 bg-[#ffffff08] rounded-lg">
                    <img src="/images/ss7.png" alt="" className="object-cover w-full h-64 sm:h-96 lg:col-span-7 dark:bg-gray-500 rounded-t-lg lg:rounded-t-none lg:rounded-l-lg"/>
                    <div className="p-6 space-y-2 lg:col-span-5 rounded-b-lg lg:rounded-b-none lg:rounded-r-lg">
                        <h3 className="text-2xl font-semibold sm:text-4xl group-hover:underline group-focus:underline text-gradient">Portfolio</h3>
