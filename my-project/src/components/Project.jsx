            ...
            <div className="container max-w-6xl p-6 mx-auto space-y-6 sm:space-y-12">
                <div className="grid justify-center grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                    <a 
                        ...
                        href="https://example.com/kickcraze" 
                        className="max-w-sm mx-auto group hover:no-underline focus:no-underline bg-[#ffffff08] rounded-lg" 
                        data-aos="fade-up"
                    >
                        <img 
                            role="presentation" 
                    ...
                    <a 
                        rel="noopener noreferrer" 
                        href="https://example.com/nu-landing-page" 
                        className="max-w-sm mx-auto group hover:no-underline focus:no-underline bg-[#ffffff08] rounded-lg" 
                        data-aos="fade-up"
                    >
                        <img 
                    ...
                    <a 
                        rel="noopener noreferrer" 
                        href="https://nbaroster.netlify.app/" 
                        className="max-w-sm mx-auto group hover:no-underline focus:no-underline bg-[#ffffff08] rounded-lg" 
                        data-aos="fade-up"
                    >
                        <img 
                    ...
                    <a 
                        rel="noopener noreferrer" 
                        href="https://example.com/gym-membership" 
                        className="max-w-sm mx-auto group hover:no-underline focus:no-underline bg-[#ffffff08] rounded-lg" 
                        data-aos="fade-up"
                    >
                        <img 
                    ...
                    <a 
                        rel="noopener noreferrer" 
                        href="https://example.com/car-management" 
                        className="max-w-sm mx-auto group hover:no-underline focus:no-underline bg-[#ffffff08] rounded-lg" 
                        data-aos="fade-up"
                    >
                        <img 
