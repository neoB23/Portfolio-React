    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-neutral-950">
            ...
            <div className="flex flex-row space-x-4 text-2xl">
                <button className="flex items-center px-10 py-5 bg-white text-black rounded-full hover:bg-blue-600">
                ...
                <button className="flex items-center px-10 py-5 bg-neutral-600 text-white rounded-full hover:bg-green-600">
